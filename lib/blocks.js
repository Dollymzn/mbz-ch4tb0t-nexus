...
const BLOCK_META = {
  ...
  fb_images:        { maxTokens: 7000,  deps: ['persona_identity'],   kind: 'text',          postprocess: null },
  ...
  image_prompts:    { maxTokens: 7000,  deps: ['onboard', 'sequence', 'persona_identity'], kind: 'text', postprocess: null },
  creatives_prompt: { maxTokens: 20000, deps: ['persona_identity'],   kind: 'text',          postprocess: null,
  ...
  video_prompts:    { maxTokens: 20000, deps: ['creatives_prompt', 'audios', 'persona_identity'], kind: 'text', requireJson: () => true, postprocess: null },
